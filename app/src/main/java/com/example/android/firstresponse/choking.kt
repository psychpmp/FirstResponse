...
class choking : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagebuttoncallbutton=findViewById<ImageButton>(R.id.callbutton1)
        imagebuttoncallbutton.setOnClickListener{
            val Intent= Intent(this,HelplineActivity::class.java)
            startActivity(Intent)
        }

        val imagebuttoncallbutton1=findViewById<ImageButton>(R.id.callbutton2)
        imagebuttoncallbutton1.setOnClickListener{
            val Intent= Intent(this,HelplineActivity::class.java)
            startActivity(Intent)
        }
