...
class PanicAttackResponse : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagebuttongroundingbutton=findViewById<ImageButton>(R.id.groundingbutton1)
        imagebuttongroundingbutton.setOnClickListener{
